	...
	if (index > 0){
		...
		if (fp != NULL){
			...
			for(i = 0; i < index; ++i){
				...
				//fprintf(fp, "%09.3f,", data_array[i].observer_filter_status);

				// data valid flags
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_time_valid);
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_position_valid);
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_velocity_valid);
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_orientation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_position_standard_deviation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_orientation_standard_deviation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_depth_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.age_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.range_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.azimuth_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.elevation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.observer_position_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.corrected_position_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.ned_position_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.geodetic_position_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.range_standard_deviation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.azimuth_standard_deviation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.elevation_standard_deviation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.position_standard_deviation_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.depth_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.signal_level_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.signal_to_noise_ratio_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.signal_correlation_ratio_valid);				 
				fprintf(fp, "%1d,", data_array[i].data_valid.b.signal_correlation_interference_valid);				 
				// end valid flags				
